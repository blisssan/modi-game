...
public class Spawner : MonoBehaviour
{
    ...
    void Update()
    {
        if (Time.time > nextSpawnTime)
        {
            ...
            GameObject fallingObject = (GameObject)Instantiate(fallingBlockPrefab, spawnPosition, Quaternion.Euler(Vector3.forward * spawnAngle));
            fallingObject.transform.localScale = Vector2.one * spawnSize;
        }
    }
}
